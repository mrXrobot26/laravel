...
@auth
    ...
    <header class="header-bar mb-3">
        <div class="container d-flex flex-column flex-md-row align-items-center p-3">
            <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Threadify</a></h4>
...
@if (session()->has('success') || session()->has('fail'))
    <div style="display: flex; justify-content: center; align-items: center;">
        <div style="padding: 10px 20px; width: 50%; text-align: center; border-radius: 8px;
        {{ session()->has('success') ? 'background-color: #d4edda; color: #155724;' : 'background-color: #f8d7da; color: #721c24;' }}">
...
<footer class="border-top text-center small text-muted py-3">
    <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">Threadify</a>. All rights reserved.</p>
</footer>
